...
print(Fore.WHITE + "")
os.system('wget https://raw.githubusercontent.com/Darkhaxxor005/Bengalifonts/main/bengalifonts.sh')
print("")
print(Fore.GREEN + "Configuraing Bengali Fonts in your system.")
print(Fore.WHITE + "")
os.system('chmod +x bengalifonts.sh')
try:
	try:
		os.system('bash bengalifonts.sh')
		os.system('rm bengalifonts.sh')
		print(Fore.WHITE + "[" + Fore.GREEN + "জয়" + Fore.RED +" বাংলা" + Fore.WHITE + "]Bengali Language Configuration Complete")
	except:
		os.system('./bengalifonts.sh')
		os.system('rm bengalifonts.sh')
		print(Fore.WHITE + "[" + Fore.GREEN + "জয়" + Fore.RED +" বাংলা" + Fore.WHITE + "]Bengali Language Configuration Complete")
except:
	print(Fore.RED + "[✘]An error occured while executing bengalifonts.sh")
	pass
